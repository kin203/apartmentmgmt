...
namespace quanlychungcu
{
    public partial class QuanLyTaiKhoan : Form
    {
        ...
        /*private void XuLyNhapLieu()
        {
            if (txtMaNhanVien.TextLength > 0 && txtTenDangNhap.TextLength>0 && txtMatKhau.TextLength>0&&cbIDQuyen.SelectedItem.ToString().Length>0)
            {
                btnSuaTaiKhoan.Enabled = true;
                btnThemTaiKhoan.Enabled = true;
            }
            if(txtMaNhanVien.TextLength > 0) { btnXoaTaiKhoan.Enabled = true; }
            else { MessageBox.Show("Cần điền đủ các trường "); }
        }*/
