...
namespace quanlychungcu
{
    public partial class ChuongTrinh : Form
    {
        ...
        {
            try {
            if (cbChonThongKe.SelectedItem.ToString().Length > 0 && cbChonLoaiHD.SelectedItem.ToString().Length > 0) {
                if (cbChonThongKe.SelectedItem.ToString() == "Theo Tháng")
                {
                    if (cbMonth.SelectedItem.ToString().Length > 0)
                    {
                        try
                        {
                    ...
                    else MessageBox.Show("Vui lòng chọn tháng");
                ...
                else
                {
                    ...
                    else MessageBox.Show("Vui lòng điền năm cần thống kê");
                }
            }
            else { MessageBox.Show("Vui lòng chọn và điền đủ các trường"); }
            } catch  { MessageBox.Show("Vui lòng chọn và điền đủ các trường"); }
        }
        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                saveFileDialog.Title = "Lưu file Excel Thống Kê";
