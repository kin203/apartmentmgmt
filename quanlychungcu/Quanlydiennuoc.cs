...
namespace quanlychungcu
{
    public partial class Quanlydiennuoc : Form
    {
        ...
        {
            numberSoLuongDien.Maximum = 500;
            numberSoLuongNuoc.Maximum = 100;
            getDataDien();
            getDataNuoc();
        ...
        {
            string query = "INSERT INTO hoadondien (mahddien, tenhoadon, manhanvien, mahogd, macanho, ngayin, soluong, dongia, ghichu) " +
                                  "VALUES (@mahddien, @tenhoadon, @manhanvien, @mahogd, @macanho, @ngayin, @soluong, @dongia, @ghichu)";
        ...
        private void btnSuaHDDien_Click(object sender, EventArgs e)
        {
            ...
            string query = "update hoadondien set tenhoadon=@tenhoadon, manhanvien=@manhanvien, mahogd=@mahogd, macanho=@macanho,ngayin= @ngayin, soluong=@soluong,dongia=@dongia, ghichu=@ghichu where mahddien=@mahddien";
        ...
        {
            string query = "INSERT INTO hoadonnuoc (mahdnuoc, tenhoadon, manhanvien, mahogd, macanho, ngayin, soluong,dongia, ghichu) " + 
                                  "VALUES (@mahdnuoc, @tenhoadon, @manhanvien, @mahogd, @macanho, @ngayin, @soluong,@dongia, @ghichu)";
        ...
        private void btnSuaHDNuoc_Click(object sender, EventArgs e)
        {
            ...
            string query = "update hoadonnuoc set tenhoadon= @tenhoadon, manhanvien=@manhanvien, mahogd=@mahogd, macanho=@macanho,ngayin= @ngayin, soluong=@soluong,dongia=@dongia, ghichu=@ghichu where mahdnuoc=@mahdnuoc";
        ...
        private void dgvDien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                txtMahoadonDien.Enabled = false;
                btnThemHDDien.Enabled = false;
                ...
                if (dgvDien.Rows[r].Cells["soluong"].Value != DBNull.Value)
                {
        ...
        private void dgvNuoc_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.RowIndex < dgvNuoc.Rows.Count)
            {
                ...
                if (dgvDien.Rows[r].Cells["soluong"].Value != DBNull.Value)
                {
                    numberSoLuongNuoc.Value = Convert.ToDecimal(dgvDien.Rows[r].Cells["soluong"].Value);
                }
                else
                {
                    numberSoLuongDien.Value = 0; 
