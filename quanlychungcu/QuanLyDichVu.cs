...
namespace quanlychungcu
{
    public partial class QuanLyDichVu : Form
    {
        ...
        {
            string query = "INSERT INTO hoadondv (mahoadondv, tenhoadon, manhanvien, mahogd, macanho, ngayin, soluong, dongia, ghichu,madichvu) " +
                                   "VALUES (@mahoadondv, @tenhoadon, @manhanvien, @mahogd, @macanho, @ngayin, @soluong,@dongia, @ghichu,@madichvu)";
        ...
        private void dgvTTHoaDonDV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.RowIndex < dgvTTHoaDonDV.Rows.Count)
            {
                ...
                if (dgvTTHoaDonDV.Rows[r].Cells["soluong"].Value != DBNull.Value)
                {
        ...
        private void btnSuaHDDV_Click(object sender, EventArgs e)
        {
            ...
            string query = "update hoadondv set  tenhoadon=@tenhoadon, manhanvien=@manhanvien, mahogd=@mahogd, macanho=@macanho,ngayin= @ngayin, soluong=@soluong,dongia=@dongia, ghichu=@ghichu,madichvu=@madichvu where mahoadondv=@mahoadondv";
